...
/**
 * TbProductSearch represents the model behind the search form of `frontend\modules\app\models\TbProduct`.
 */
class TbProductSearch extends TbProduct
{
    ...
    {
        return [
            [['product_id', 'product_name', 'created_at', 'updated_at'], 'safe'],
