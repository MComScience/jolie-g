                ...
                <div class="stats-label text-color">
                    ...
                    <div class="dropdown">
                        <a class="dropdown-toggle" href="#" data-toggle="dropdown">
                            <small class="text-muted">เพิ่มเติม <b class="caret"></b></small>
                        </a>
                        <ul class="dropdown-menu animated flipInX m-t-xs">
                            <li><?= Html::a(Yii::t('frontend','Profile'),['/user/settings/profile']) ?></li>
                            <li class="divider"></li>
                            <li><?= Html::a(Yii::t('frontend','Logout'),['/auth/logout'],['data-method' => 'post']) ?></li>
                        </ul>
                    </div>
