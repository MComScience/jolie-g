        ...
        <div id="navbar" class="navbar-collapse collapse">
            ...
            echo Nav::widget([
                'items' => ArrayHelper::merge([
                    ...
                    ['label' => 'คิวอาร์โค้ดของฉัน', 'url' => '#qrcode','linkOptions' => ['class' => 'page-scroll'], 'visible' => !Yii::$app->user->isGuest],
                    ['label' => 'Lucky Draw', 'url' => '#luckydraw','linkOptions' => ['class' => 'page-scroll'], 'visible' => !Yii::$app->user->isGuest],
